...
class time_dependent:
    ...
    def find_bc(self,gamma_sigma,F,T,N_E,K_list,mkt_vols,obj,start_params,b):
...
#calibrate for the second month 
    ...
    b1 = time_dependent(a, dt, m, b_list, c_list).find_bc(gamma_sigma_list, Future[1], T_M[:2], N_E[1], K[1], "Future Price", 0.1, [])
